...
- If you are not a member yet, [click here to join The Carpentries Slack channel](https://slack-invite.carpentries.org/).
...
In the past, Gitter has mainly been used by the Library Carpentry community for sprints. The #libraries Slack channel is [now primarily promoted](https://carpentries.slack.com/archives/CFFM1KQJH/p1550467370007400) as the preferred everyday communication platform for the Libraries community.
